 ...
 *
 * A builder interface for modifying [com.motadata.android.api.instrumentation.network.HttpRequestInfo] instances.
 * This interface allows to build new [com.motadata.android.api.instrumentation.network.HttpRequestInfo] with
 * modified HTTP request properties such as URL, headers, and tags.
 *
 * Use [com.motadata.android.api.instrumentation.network.MutableHttpRequestInfo.newBuilder] to obtain a builder instance.
 */
@InternalApi
interface HttpRequestInfoBuilder {
    ...
    /**
     * Builds and returns the modified [com.motadata.android.api.instrumentation.network.HttpRequestInfo].
     * @return the resulting [com.motadata.android.api.instrumentation.network.HttpRequestInfo] with all modifications applied.
     */
