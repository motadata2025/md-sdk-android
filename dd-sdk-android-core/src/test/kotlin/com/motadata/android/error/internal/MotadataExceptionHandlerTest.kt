...
import com.motadata.android.core.internal.thread.waitToIdle
import com.motadata.android.core.internal.utils.TAG_DATADOG_UPLOAD
import com.motadata.android.core.internal.utils.UPLOAD_WORKER_NAME
import com.motadata.android.internal.tests.stub.StubTimeProvider
...
internal class MotadataExceptionHandlerTest {

    private var originalHandler: Thread.UncaughtExceptionHandler? = null

    lateinit var testedHandler: MotadataExceptionHandler
    ...
    fun `set up`() {
        ...
        testedHandler = MotadataExceptionHandler(
            sdkCore = mockSdkCore,
    ...
    fun `M wait for the executor to idle W exception caught`() {
        ...
        verify(mockScheduledThreadExecutor)
            .waitToIdle(MotadataExceptionHandler.MAX_WAIT_FOR_IDLE_TIME_IN_MS, mockInternalLogger, stubTimeProvider)
        mockInternalLogger.verifyLog(
            InternalLogger.Level.WARN,
            InternalLogger.Target.USER,
            MotadataExceptionHandler.EXECUTOR_NOT_IDLED_WARNING_MESSAGE,
            mode = never()
        )
    }
    ...
    fun `M log warning message W exception caught { executor could not be idled }`() {
        ...
        val timeoutNs = MotadataExceptionHandler.MAX_WAIT_FOR_IDLE_TIME_IN_MS * 1_000_000L
    ...
    fun `M log dev info W caught exception { no RUM feature registered }`() {
        ...
        mockInternalLogger.verifyLog(
            ...
            InternalLogger.Target.USER,
            MotadataExceptionHandler.MISSING_RUM_FEATURE_INFO
        )
    }
