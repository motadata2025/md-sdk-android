...
import com.motadata.android.utils.forge.CustomAttributes
...
/**
 * This region groups all test about instantiating a MotadataCore instance.
...
internal class MotadataCoreInitializationTest {

    lateinit var testedCore: MotadataCore
    ...
    fun `M throw an error W initialize() {envName not valid, isDebug=false}`(
        ...
        assertThat(exception)
            .hasMessage(MotadataCore.MESSAGE_ENV_NAME_NOT_VALID)
    }
