...
package com.motadata.android.core.internal.account

import com.motadata.android.api.InternalLogger
import com.motadata.android.api.context.AccountInfo
import com.motadata.android.core.internal.account.MotadataAccountInfoProvider.Companion.MSG_ACCOUNT_NULL
...
internal class MotadataAccountInfoProviderTest {

    private lateinit var testedProvider: MotadataAccountInfoProvider
    ...
    @BeforeEach
    fun `set up`() {
        testedProvider = MotadataAccountInfoProvider(mockInternalLogger)
    }
