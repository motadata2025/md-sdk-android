...
package com.motadata.android.core.internal.user
...
internal class MotadataUserInfoProviderTest {

    private lateinit var testedProvider: MotadataUserInfoProvider

    @BeforeEach
    fun `set up`() {
        testedProvider = MotadataUserInfoProvider()
    }
