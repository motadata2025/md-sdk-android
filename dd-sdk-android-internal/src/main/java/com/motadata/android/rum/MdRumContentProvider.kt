 ...
 */
class MdRumContentProvider : ContentProvider() {
    ...
    override fun onCreate(): Boolean {
        if (processImportance == 0) {
            ...
            Log.w("MdRumContentProvider", "processImportance:$processImportance")
        }
        return true
    }
    ...
    companion object {
        ...
        /**
         * Process importance at the moment of creating [MdRumContentProvider]
