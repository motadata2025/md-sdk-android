...
internal class MotadataGlideModuleTest {
    ...
    @BeforeEach
    fun `set up`() {
        testedModule = MotadataGlideModule(firstPartyHosts = listOf(fakeHost))
    }
    ...
    private fun assertUncaughtExceptionHandler(executor: GlideExecutor) {
        ...
        assertThat(strategy).isInstanceOf(MotadataRUMUncaughtThrowableStrategy::class.java)
    }
}
