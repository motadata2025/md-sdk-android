 ...
 */
open class MotadataGlideModule
@JvmOverloads
constructor(
    ...
    override fun applyOptions(context: Context, builder: GlideBuilder) {
        ...
        diskExecutorBuilder.setUncaughtThrowableStrategy(
            MotadataRUMUncaughtThrowableStrategy("Disk Cache", sdkInstanceName)
        )
        sourceExecutorBuilder.setUncaughtThrowableStrategy(
            MotadataRUMUncaughtThrowableStrategy("Source", sdkInstanceName)
        )
