...
import com.motadata.android.okhttp.TraceContext as DeprecatedTraceContext
...
internal constructor(
    ...
    abstract class BaseBuilder<out T : TracingInterceptor, out R : BaseBuilder<T, R>>(
        ...
        /**
         * Deprecated. Use setTraceContextInjection(com.motadata.android.trace.TraceContextInjection) instead.
         *
         * Set the trace context injection behavior for this interceptor in the intercepted requests.
         * By default this is set to [TraceContextInjection.SAMPLED], meaning that only the sampled request will
         * propagate the trace context. In case of [TraceContextInjection.ALL] all the trace context
         ...
         */
        @Deprecated("Use setTraceContextInjection(com.motadata.android.trace.TraceContextInjection) instead")
        fun setTraceContextInjection(traceContextInjection: com.motadata.android.okhttp.TraceContextInjection): R {
            return setTraceContextInjection(
                when (traceContextInjection) {
                    com.motadata.android.okhttp.TraceContextInjection.ALL -> TraceContextInjection.ALL
                    com.motadata.android.okhttp.TraceContextInjection.SAMPLED -> TraceContextInjection.SAMPLED
                }
            )
        }
