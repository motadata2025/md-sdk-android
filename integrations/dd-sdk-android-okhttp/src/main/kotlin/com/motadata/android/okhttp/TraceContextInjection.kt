...
/**
 * Deprecated. Use [com.motadata.android.trace.TraceContextInjection] instead* with the
 * corresponding method in [com.motadata.android.okhttp.trace.TracingInterceptor.Builder]:
 * fun setTraceContextInjection(traceContextInjection: com.motadata.android.trace.TraceContextInjection)
 *
 * Defines whether the trace context should be injected into all requests or only sampled ones.
 */
@Deprecated(
    "Use com.motadata.android.trace.TraceContextInjection instead.",
    replaceWith = ReplaceWith(
        "TraceContextInjection",
        imports = ["com.motadata.android.trace.TraceContextInjection"]
    )
)
