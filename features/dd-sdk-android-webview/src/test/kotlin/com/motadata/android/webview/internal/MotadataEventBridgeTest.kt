...
package com.motadata.android.webview.internal
...
internal class MotadataEventBridgeTest {

    lateinit var testedDatadogEventBridge: MotadataEventBridge
    ...
    @BeforeEach
    fun `set up`() {
        testedDatadogEventBridge = MotadataEventBridge(
    ...
    fun `M return sanitized webViewTrackingHosts W getAllowedWebViewHosts() { allow IP addresses }`(
        ...
        testedDatadogEventBridge = MotadataEventBridge(mock(), hosts, fakePrivacyLevel)
