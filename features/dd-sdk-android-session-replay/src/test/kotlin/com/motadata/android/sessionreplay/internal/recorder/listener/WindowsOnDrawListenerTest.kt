...
package com.motadata.android.sessionreplay.internal.recorder.listener
...
import com.motadata.android.sessionreplay.internal.async.SnapshotRecordedDataQueueItem
import com.motadata.android.sessionreplay.internal.recorder.Debouncer
import com.motadata.android.sessionreplay.internal.recorder.Node
import com.motadata.android.sessionreplay.internal.recorder.SnapshotProducer
    ...
    fun `M call methodCall telemetry with true W onDraw() { has nodes }`() {
        ...
        whenever(
            mockInternalLogger.startPerformanceMeasure(
                "com.motadata.android.sessionreplay.internal.recorder.listener.WindowsOnDrawListener",
