...
import com.motadata.android.flags.internal.model.VariationType
import com.motadata.android.flags.internal.repository.FlagsRepository
import com.motadata.android.flags.model.ErrorCode
import com.motadata.android.flags.model.EvaluationContext
import com.motadata.android.flags.model.ResolutionReason
...
internal class MotadataFlagsClientTest {
    ...
    private lateinit var testedClient: MotadataFlagsClient
    ...
    fun `set up`(forge: Forge) {
        ...
        testedClient = MotadataFlagsClient(
    ...
    fun `M track error evaluation W resolve() { flag not found and trackEvaluations enabled }`(forge: Forge) {
        ...
        val clientWithEvaluationTracking = MotadataFlagsClient(
            featureSdkCore = mockFeatureSdkCore,
            evaluationsManager = mockEvaluationsManager,
            flagsRepository = mockFlagsRepository,
            flagsConfiguration = forge.getForgery<FlagsConfiguration>().copy(
