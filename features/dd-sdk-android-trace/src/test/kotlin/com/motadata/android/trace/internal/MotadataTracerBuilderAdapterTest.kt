...
import com.motadata.android.trace.api.MotadataTracingConstants.TracerConfig
import com.motadata.android.trace.internal.MotadataTracerBuilderAdapter.Companion.DEFAULT_URL_AS_RESOURCE_NAME
import com.motadata.android.trace.internal.MotadataTracerBuilderAdapter.Companion.toPropagationStyle
...
class MotadataTracerBuilderAdapterTest {
    private lateinit var testedBuilder: MotadataTracerBuilderAdapter
    ...
    fun `set up`() {
        ...
        testedBuilder = MotadataTracerBuilderAdapter(mockSdkCore, fakeServiceName, mockBuilder)
    }
    ...
    fun `M return default properties W properties() {no method called}`() {
        ...
        expected.setProperty(
            ...
            MotadataTracerBuilderAdapter.DEFAULT_PARTIAL_MIN_FLUSH.toString()
        )
    ...
    fun `M return tracer with expected parameters W build`() {
        ...
        val tracer = testedBuilder
            ...
            .build() as MotadataTracerAdapter
        ...
        argumentCaptor<MotadataScopeListenerAdapter> {
