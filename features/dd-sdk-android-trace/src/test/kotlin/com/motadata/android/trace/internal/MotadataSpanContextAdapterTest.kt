...
class MotadataSpanContextAdapterTest {
    ...
    private lateinit var testedAgentSpanContextAdapter: MotadataSpanContextAdapter
    private lateinit var testedDDSpanContextContextAdapter: MotadataSpanContextAdapter

    @BeforeEach
    fun `set up`() {
        testedAgentSpanContextAdapter = MotadataSpanContextAdapter(mockAgentSpanContext)
        testedDDSpanContextContextAdapter = MotadataSpanContextAdapter(mockDDSpanContext)
    }
    ...
    fun `M return delegate#traceId W traceId is called`(forge: Forge) {
        ...
        // Then
        assertThat(actualTraceId).isEqualTo(MotadataTraceIdAdapter(ddTraceId))
    }
}
