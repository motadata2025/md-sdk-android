...
import com.motadata.android.trace.event.NoOpSpanEventMapper
...
data class TraceConfiguration internal constructor(
    ...
    class Builder {
        ...
        /**
         * Sets the [SpanEventMapper] for the Trace [com.motadata.android.trace.model.SpanEvent].
         * You can use this interface implementation to modify the
         * [com.motadata.android.trace.model.SpanEvent] attributes before serialisation.
         *
