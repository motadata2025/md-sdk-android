...
internal class MotadataTracerBuilderAdapter(
    private val sdkCore: FeatureSdkCore,
    private var serviceName: String,
    private val delegate: CoreTracer.CoreTracerBuilder
) : MotadataTracerBuilder {
    ...
    override fun build(): MotadataTracer {
        val coreTracer = delegate.withProperties(properties()).build()
        val spanLogger = MotadataSpanLogger(sdkCore)
        val datadogTracer = MotadataTracerAdapter(sdkCore, coreTracer, bundleWithRumEnabled, spanLogger)
