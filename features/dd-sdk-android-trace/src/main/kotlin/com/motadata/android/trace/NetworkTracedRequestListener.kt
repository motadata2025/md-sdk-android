...
/**
 * Listener for automatically created [com.motadata.android.trace.api.span.MotadataSpan] around [com.motadata.android.api.instrumentation.network.HttpRequestInfo].
 */
@NoOpImplementation
interface NetworkTracedRequestListener {
     ...
     * You can update the given [com.motadata.android.trace.api.span.MotadataSpan] (e.g.: add custom tags / baggage items) before it
     ...
     * @param span the [com.motadata.android.trace.api.span.MotadataSpan] created around the intercepted [com.motadata.android.api.instrumentation.network.HttpRequestInfo]
