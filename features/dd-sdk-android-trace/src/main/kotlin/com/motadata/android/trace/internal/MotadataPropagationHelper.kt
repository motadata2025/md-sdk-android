 ...
 */
@InternalApi
class MotadataPropagationHelper internal constructor() {
    /**
     * Determines if the provided [MotadataSpanContext] represents an extracted context.
     *
     * @param context The [MotadataSpanContext] to be evaluated.
    ...
    fun isExtractedContext(context: MotadataSpanContext): Boolean {
        if (context !is MotadataSpanContextAdapter) return false
     ...
     */
    fun extractParentContext(tracer: MotadataTracer, request: HttpRequestInfo): MotadataSpanContext? {
    ...
    private fun extractTraceContext(request: HttpRequestInfo): MotadataSpanContext? =
        request.tag(MotadataSpan::class.java)?.context()
    ...
    /**
     * Creates a [MotadataSpanContext] object that represents an extracted context from the given parameters.
     *
     ...
     * @return A [MotadataSpanContext] instance containing the extracted context.
     */
    ...
    fun createExtractedContext(
        ...
        spanId: String,
        samplingPriority: Int
    ): MotadataSpanContext = MotadataSpanContextAdapter(
        ExtractedContext(
