...
import com.motadata.android.internal.data.SharedPreferencesStorage
import com.motadata.android.internal.system.BuildSdkVersionProvider
import com.motadata.android.profiling.MdProfilingContentProvider.Companion.TELEMETRY_APP_START_INFO_ACTIVITY
import com.motadata.android.profiling.MdProfilingContentProvider.Companion.TELEMETRY_APP_START_INFO_LAUNCHER
import com.motadata.android.profiling.MdProfilingContentProvider.Companion.TELEMETRY_APP_START_INFO_RECENTS
import com.motadata.android.profiling.forge.Configurator
...
import com.motadata.android.profiling.internal.perfetto.PerfettoProfiler.Companion.TELEMETRY_KEY_APP_START_INFO
...
class MdProfilingContentProviderTest {

    private lateinit var testedProvider: MdProfilingContentProvider
    ...
    fun `set up`() {
        ...
        testedProvider = MdProfilingContentProvider(mockBuildSdkVersionProvider)
    }
