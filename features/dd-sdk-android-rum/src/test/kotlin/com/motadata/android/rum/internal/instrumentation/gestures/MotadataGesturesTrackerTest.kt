...
package com.motadata.android.rum.internal.instrumentation.gestures
...
internal class MotadataGesturesTrackerTest : ObjectTest<MotadataGesturesTracker>() {

    lateinit var testedTracker: MotadataGesturesTracker
    ...
    override fun createInstance(forge: Forge): MotadataGesturesTracker {
    ...
    override fun createEqualInstance(
        source: MotadataGesturesTracker,
        forge: Forge
    ): MotadataGesturesTracker {
        return MotadataGesturesTracker(
