...
import com.motadata.android.rum.internal.RumFeature.Configuration
...
import com.motadata.android.rum.internal.utils.HUNDRED
import com.motadata.android.rum.internal.utils.percent
...
import com.motadata.android.telemetry.model.TelemetryConfigurationEvent.TrackResourceHeaders
...
import com.motadata.android.telemetry.model.TelemetryUsageEvent.ActionType
...
internal class TelemetryEventHandler(
    ...
    private fun isGlobalTracerRegistered(): Boolean {
        // We don't reference com.motadata.android.trace from RUM directly, so using reflection for this.
        // Would be nice to add the test with the flavor which is has no com.motadata.android.trace and test
