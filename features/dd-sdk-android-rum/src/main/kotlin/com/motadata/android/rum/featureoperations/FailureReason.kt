 ...
 */
package com.motadata.android.rum.featureoperations

/**
 * Represents the possible reasons for a failed feature operation.
 */
@Deprecated(
    "Use com.motadata.android.rum.operations.FailureReason instead",
    replaceWith = ReplaceWith(
        expression = "FailureReason",
        imports = ["com.motadata.android.rum.operations.FailureReason"]
    )
)
