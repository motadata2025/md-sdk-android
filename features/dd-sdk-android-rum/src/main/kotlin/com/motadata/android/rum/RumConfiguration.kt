...
import com.motadata.android.rum.event.ViewEventMapper
...
data class RumConfiguration internal constructor(
    ...
    class Builder(private val applicationId: String) {
         ...
         * @see [com.motadata.android.rum.tracking.ActivityViewTrackingStrategy]
         * @see [com.motadata.android.rum.tracking.FragmentViewTrackingStrategy]
         * @see [com.motadata.android.rum.tracking.MixedViewTrackingStrategy]
         * @see [com.motadata.android.rum.tracking.NavigationViewTrackingStrategy]
         */
