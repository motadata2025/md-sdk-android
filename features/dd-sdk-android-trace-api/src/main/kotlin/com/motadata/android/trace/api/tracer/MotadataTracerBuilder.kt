...
/**
 * Builder interface for creating and configuring a [MotadataTracer] instance.
 */
@NoOpImplementation(publicNoOpImplementation = true)
@SuppressWarnings("TooManyFunctions")
interface MotadataTracerBuilder {
    /**
     * Constructs and returns an instance of [MotadataTracer] based on the current builder configuration.
     *
     * @return An instance of [MotadataTracer] configured with the options provided in the builder.
     */
    fun build(): MotadataTracer
     ...
     * headers to be used.
     * @return The updated instance of [MotadataTracerBuilder] to allow method chaining.
     */
    fun withTracingHeadersTypes(tracingHeadersTypes: Set<TracingHeaderType>): MotadataTracerBuilder
     ...
     * @return The updated instance of [MotadataTracerBuilder] to allow method chaining.
     */
    fun withServiceName(serviceName: String): MotadataTracerBuilder

    /**
     * Sets the sample rate of spans.
     * @param sampleRate the sample rate as a percentage between 0 and 100 (default is 100%)
     */
    fun withSampleRate(@FloatRange(from = 0.0, to = 100.0) sampleRate: Double): MotadataTracerBuilder
     ...
     * @return The updated instance of [MotadataTracerBuilder] to allow method chaining.
     */
    fun withPartialFlushMinSpans(partialFlushMinSpans: Int): MotadataTracerBuilder
     ...
     */
    fun withTag(key: String, value: String): MotadataTracerBuilder
     ...
     */
    fun setBundleWithRumEnabled(enabled: Boolean): MotadataTracerBuilder
