...
interface MotadataSpan {
     ...
     */
    val localRootSpan: MotadataSpan?

    /**
     * Retrieves the context associated with this Motadata span.
     *
     * @return The [MotadataSpanContext] containing trace and span-specific information such as identifiers, sampling priority, and tags.
     */
    fun context(): MotadataSpanContext
    ...
    /**
     * Logs a throwable and associates it with the current [MotadataSpan].
     *
    ...
    /**
     * Logs an error message and associates it with the current [MotadataSpan].
     *
    ...
    /**
     * Logs a message associated with the current [MotadataSpan].
     *
    ...
    /**
     * Logs a set of attributes and associates them with the current [MotadataSpan].
     *
