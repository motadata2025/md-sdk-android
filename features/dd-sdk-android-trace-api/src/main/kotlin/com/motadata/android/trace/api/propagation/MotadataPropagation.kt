...
interface MotadataPropagation {
     ...
     * @param context The [MotadataSpanContext] containing the trace and span information to inject.
    ...
    /**
     * Extracts a [MotadataSpanContext] from the provided carrier using the specified getter function.
     ...
     * @return The extracted [MotadataSpanContext] if one could be retrieved, or null otherwise.
     */
    fun <C> extract(
        carrier: C,
