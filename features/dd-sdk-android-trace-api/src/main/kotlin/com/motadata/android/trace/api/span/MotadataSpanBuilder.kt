 ...
 */
package com.motadata.android.trace.api.span

import com.datadog.tools.annotation.NoOpImplementation

/**
 * Builder interface for creating instances of [MotadataSpan].
 * Provides methods to configure various attributes and context of a Motadata span
 * before initializing it.
 */
@NoOpImplementation
@SuppressWarnings("TooManyFunctions")
interface MotadataSpanBuilder {

    /**
     * Builds and starts a new span with the current configuration of the builder.
     *
     * @return The newly created instance of [MotadataSpan].
     */
    fun start(): MotadataSpan
     ...
     * @return The current instance of [MotadataSpanBuilder] to allow method chaining.
     */
    fun withOrigin(origin: String?): MotadataSpanBuilder
     ...
     * @return The current instance of [MotadataSpanBuilder] to allow method chaining.
     */
    fun withTag(key: String, value: Double?): MotadataSpanBuilder
     ...
     * @return The current instance of [MotadataSpanBuilder] to allow method chaining.
     */
    fun withTag(key: String, value: Long?): MotadataSpanBuilder
     ...
     * @return The current instance of [MotadataSpanBuilder] to allow method chaining.
     */
    fun withTag(key: String, value: Any?): MotadataSpanBuilder
     ...
     * @return The current instance of [MotadataSpanBuilder] to allow method chaining.
     */
    fun withResourceName(resourceName: String?): MotadataSpanBuilder
     ...
     * @return The current instance of [MotadataSpanBuilder] to enable method chaining.
     */
    fun withParentContext(parentContext: MotadataSpanContext?): MotadataSpanBuilder
     ...
     * @return The current instance of [MotadataSpanBuilder] to enable method chaining.
     */
    fun withParentSpan(parentSpan: MotadataSpan?): MotadataSpanBuilder
     ...
     * @return The current instance of [MotadataSpanBuilder] to allow method chaining.
     */
    fun withStartTimestamp(micros: Long): MotadataSpanBuilder
     ...
     * @return The current instance of [MotadataSpanBuilder] to allow method chaining.
     */
    fun ignoreActiveSpan(): MotadataSpanBuilder
     ...
     * @return The current instance of [MotadataSpanBuilder] to allow method chaining.
     */
    fun withLink(link: MotadataSpanLink): MotadataSpanBuilder
}
