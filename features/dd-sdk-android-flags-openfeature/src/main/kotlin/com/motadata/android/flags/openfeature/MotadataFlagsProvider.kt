...
import com.motadata.android.flags.FlagsStateListener
import com.motadata.android.flags.model.FlagsClientState
import com.motadata.android.flags.openfeature.internal.adapters.convertToValue
import com.motadata.android.flags.openfeature.internal.adapters.toDatadogEvaluationContext
import com.motadata.android.flags.openfeature.internal.adapters.toOpenFeatureErrorCode
import com.motadata.android.flags.openfeature.internal.adapters.toProviderEvaluation
import com.motadata.android.flags.openfeature.internal.setEvaluationContextSuspend
...
import com.motadata.android.flags.model.EvaluationContext as DatadogEvaluationContext
 ...
 */
class MotadataFlagsProvider private constructor(private val flagsClient: FlagsClient, sdkCore: FeatureSdkCore) :
    FeatureProvider {
    ...
    companion object {
        ...
        ): MotadataFlagsProvider = MotadataFlagsProvider(flagsClient, sdkCore)
    }
}
