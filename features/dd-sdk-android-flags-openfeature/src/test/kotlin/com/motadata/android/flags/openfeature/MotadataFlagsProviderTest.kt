...
import com.motadata.android.flags.StateObservable
...
internal class MotadataFlagsProviderTest {
    ...
    private lateinit var provider: MotadataFlagsProvider
    ...
    fun setUp() {
        ...
        provider = MotadataFlagsProvider.wrap(mockFlagsClient, mockSdkCore)
    }
