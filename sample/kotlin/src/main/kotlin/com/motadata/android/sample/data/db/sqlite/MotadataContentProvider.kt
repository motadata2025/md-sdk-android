...
import com.motadata.android.trace.sqlite.transactionTraced

internal class MotadataContentProvider : ContentProvider() {

    lateinit var sqliteHelper: MotadataSqliteHelper
    ...
    override fun query(
        ...
        return when (uriMatcher.match(uri)) {
            LOGS_MATCHER -> {
                ...
                return db.query(
                    MotadataDbContract.Logs.TABLE_NAME,
                    projection,
                    selection,
                    selectionArgs,
                    null,
    ...
    override fun onCreate(): Boolean {
        context?.let {
            sqliteHelper = MotadataSqliteHelper(it)
        }
        return true
    }
    ...
    companion object {
        private const val CONTENT_PROVIDER_AUTHORITY = "com.motadata.android.provider"
