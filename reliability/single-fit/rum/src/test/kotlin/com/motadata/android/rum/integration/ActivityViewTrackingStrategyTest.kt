    ...
    fun `M send RUM View W onActivityResumed()`() {
        ...
        assertThat(eventsWritten)
            ...
            .hasRumEvent(index = 0) {
                ...
                hasSource("android")
                hasType("view")
                hasViewUrl("com/motadata/android/rum/integration/ActivityViewTrackingStrategyTest/StubActivity")
                hasViewName("com.motadata.android.rum.integration.ActivityViewTrackingStrategyTest.StubActivity")
            }
    }
